...
class insert(Resource):
    ...
    def post(self):
      #  Extract all values from json incoming
        ...
        #Generate minnerID to send to project Air, we use random numbers to avoid duplicate hash (In Testing Scenario)
        minnerID_ = minnerID+'-'+str(random.randrange(1,10000)) + str(random.randrange(1,10000)) + str(random.randrange(1,10000))
        hash_params = walletID+minnerID_
        ...
        #String to Insert
        send = '_minerID_:{},_walletID_:{},_hash_:{},_gps_:{},_CO2_:{},_O3_:{},_NO2_:{},_HUM_:{},_TEMP_:{}'.format(minnerID_, walletID, hash_result, gps, c02, o3, no2, hum, temp)
